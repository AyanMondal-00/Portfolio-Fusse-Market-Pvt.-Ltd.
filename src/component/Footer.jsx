...
const Footer = () => {
  return (
    <footer className="bg-[#87b3df] text-[#000000] py-3">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-gray-600">
          {/* Fuse Market Section */}
          <div>
            <h3 className="text-lg font-bold mb-4">Fuse Market</h3>
            <p className="text-[#000000] text-xs leading-relaxed">
          ...
          <div>
            ...
            <div className="space-y-2 text-[#000000] text-xs">
              <div>
                <div>Email:</div>
                <a 
                  href="mailto:contact@fusemarket.in" 
              ...
              <div>
                <span>Address: </span>
                <a 
                  href="https://maps.google.com/?q=Sarojini+Nagar+Kanpur+Road+Lucknow" 
                  target="_blank" 
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:text-[#3865c7] transition-colors duration-300"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:text-[#f4ab1a] transition-colors duration-300"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:text-[#6c108e] transition-colors duration-300"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="hover:text-[#1868d7] transition-colors duration-300"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Copyright Section */}
        <div className="text-center text-[#000000] text-xs pt-6">
          © 2026 Fuse Market. All rights reserved.
        </div>
      </div>
    </footer>
  );
